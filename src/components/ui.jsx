...
export function Reveal({ children, delay = 0, y = 26, className = '' }) {
  ...
  /* Saat pengguna meminta lebih sedikit gerak, elemen tidak lagi bergeser
     naik dan tanpa jeda; cukup memudar masuk singkat. Konsisten dengan
     penanganan reduced-motion di Hero, StarField, dan komponen lainnya. */
  if (reduce) {
    return (
      <motion.div
        className={className}
